...
- **Remaining implementation checklist:** [delivery/REMAINING-task-satisfaction.md](plans/cline-drivemode/delivery/REMAINING-task-satisfaction.md) (hub bridge, W1–W4 moments, slice 3).
...
- Task-session satisfaction (PRD 10): W0 kernel (`callSessionId`, bank emit, hub commands, `deriveSessionRollup`) landed; **hub webview bridge + W1–W4 moments still open** — [REMAINING-task-satisfaction.md](plans/cline-drivemode/delivery/REMAINING-task-satisfaction.md). [ARD-0015](plans/cline-drivemode/ard/ARD-0015-task-session-observability.md) still **Proposed**.
