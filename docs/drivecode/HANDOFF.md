...
- **Mobile consumer app (plan):** [mobile-consumer](plans/cline-drivemode/initiatives/mobile-consumer/) — phone-first shell for less-technical users (vertical Spotlight, hold-to-talk, PWA). Wireframe [mobile-drive-app.html](design/wireframes/mobile-drive-app.html). Hosted runtime still needs an ADR-0016 decision.
