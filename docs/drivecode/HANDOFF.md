...
- **Room hot path (slices 1–4 on PR track):** [drive-hotpath](plans/cline-drivemode/initiatives/drive-hotpath/) + [ADR-0029](plans/cline-drivemode/adr/ADR-0029-room-hotpath-redesign.md) — checkpoint, delta publish, in-process stage projector, `?app=1` + plan sheet layout; cloud signaling still owner-gated (ADR-0016).
