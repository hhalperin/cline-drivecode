...
- **Room hot path (plan + slice 1):** [drive-hotpath](plans/cline-drivemode/initiatives/drive-hotpath/) + [ADR-0029](plans/cline-drivemode/adr/ADR-0029-room-hotpath-redesign.md) — fold checkpoint on retention trim (correctness); delta publish / one stage projector / layout contract / cloud signaling follow.
