...
- **MC1 partial (`?app=1`):** hub omits nav; Join/Continue lobby (`DriveView` `composition=app`); call sheets for plan/audit/captions. Next: hold-to-talk primary + 44px strip; PWA remains.
