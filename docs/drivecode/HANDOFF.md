...
- `docs/drivecode/design/brand/MOBILE-BRAND-STYLING.md` locks light-first mobile consumer tokens (green Live; Hub palette; iOS wireframe as visual SoT).
...
- **Owner defaults (2026-08-07):** [DEC-mobile-consumer-owner](plans/cline-drivemode/decisions/DEC-mobile-consumer-owner.md) — path H yes; mic default muted; PWA name **Cline Drive**; MC3 on Now. Freemium still open.
