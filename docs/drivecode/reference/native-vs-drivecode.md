...
| Multi-agent | Team tools / mailbox (runtime groups) | Room roster, address set; RosterPack seat path + recruit scoring | `scaffold` | [DRV-ROSTER-PACK](../plans/cline-drivemode/features/DRV-ROSTER-PACK.md); [DRV-RECRUIT](../plans/cline-drivemode/features/DRV-RECRUIT.md); pack library / Add UI still open |
...
| Agent identity | `.cline/agents/*.yaml` (ConfiguredAgent) | `.driveagent/<slug>/` home + AgentProfile appearance overlay + recruit scoring | `scaffold` | [ARD-0001](../plans/cline-drivemode/ard/ARD-0001-driveagent-home.md); compile fixture landed; full editor/Add UI open |
