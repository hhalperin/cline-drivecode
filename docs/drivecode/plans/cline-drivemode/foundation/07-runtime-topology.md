...
Media / WebRTC stays out until multi-user humans need bidirectional audio ([04-future-multi-user.md](../research/04-future-multi-user.md)).
...
- [02-research-streaming.md](../research/02-research-streaming.md) for signaling vs media
