...
Architecture decision: [ADR-0006](../adr/ADR-0006-pip-partner-companion.md). Prior rejection in [00-vision.md](../foundation/00-vision.md) and wireframe notes is superseded by this PRD: PiP is in scope as a **companion**, not as primary IA.

## References

- Wireframe: [design/wireframes/index.html](../../../design/wireframes/index.html) variant C · [variant-c.png](../../../design/wireframes/variants/variant-c.png)
