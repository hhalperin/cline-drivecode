...
**Parent plan.** Dependency upgrades + primitives audit (`docs/drivecode/plans/cline-drivemode/research/13-deps-inventory.md`, `14-primitives-audit.md`).
...
| Drive product | Demo share producers beyond mermaid stub, mic wiring, WebRTC, recruit/graph | Separate drivemode feature PRs; see `docs/drivecode/plans/cline-drivemode/delivery/HANDOFF.md` |
...
- Inventory: [`13-deps-inventory.md`](../research/13-deps-inventory.md)
- Primitives audit (mostly done on main): [`14-primitives-audit.md`](../research/14-primitives-audit.md)
- Broader Drive product handoff: [`HANDOFF.md`](../delivery/HANDOFF.md)
