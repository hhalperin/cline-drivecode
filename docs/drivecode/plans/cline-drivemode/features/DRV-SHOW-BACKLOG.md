...
Back to [README](../README.md). Architecture: [share-and-router/PLAN.md](../initiatives/share-and-router/PLAN.md). Implementation slices: [show-backlog-director/](../initiatives/show-backlog-director/).
...
|---|---|---|
| 1 Present trigger | [slice-1](../initiatives/show-backlog-director/slice-1-present-trigger.md) | Landed present path |
| 2 Enqueue + rank tick | [slice-2](../initiatives/show-backlog-director/slice-2-enqueue-rank-tick.md) | Slice 1 |
| 3 Script runner | [slice-3](../initiatives/show-backlog-director/slice-3-script-runner.md) | Slice 2 |
| 4 Do↔Show link | [slice-4](../initiatives/show-backlog-director/slice-4-do-show-link.md) | Slice 2 + forks |
| 5 Planner policy | [slice-5](../initiatives/show-backlog-director/slice-5-planner-policy.md) | Slices 3 + 4 |
| 6 Extra producers | [slice-6](../initiatives/show-backlog-director/slice-6-producers.md) | Slice 2 (+5 preferred) |
| 7 Router wire | [slice-7](../initiatives/show-backlog-director/slice-7-router-wire.md) | Slice 2 |
| S Stage chrome | [slice-S](../initiatives/show-backlog-director/slice-S-spotlight-converge.md) | Parallel; S3 after S1 |
...
- Treating fixture demos as production gate — use [testing.md](../initiatives/show-backlog-director/testing.md) live path.
