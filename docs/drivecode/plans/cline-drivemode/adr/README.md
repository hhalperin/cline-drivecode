...
| [ADR-0016](ADR-0016-distribution-and-positioning.md) | Drive mode distribution & positioning | Proposed — owner: Harrison | — |
| [ADR-0017](ADR-0017-narration-bound-presentation-cues.md) | Narration-bound presentation cues | Proposed — owner: Harrison | [DRV-NARRATION](../features/DRV-NARRATION.md), [DRV-TTS](../features/DRV-TTS.md) |
