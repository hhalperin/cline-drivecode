...
| [ADR-0029](ADR-0029-room-hotpath-redesign.md) | Room hot-path redesign (checkpoint, deltas, one stage clock) | **Proposed** | partial | Amends ADR-0013 hydrate guarantee. Slice 1: fold `checkpoint.json` on retention trim. Slices 2–5 (delta publish, projector, layout contract, cloud signaling) open. Initiative: [drive-hotpath](../initiatives/drive-hotpath/). |
