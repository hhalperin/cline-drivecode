...
| [ADR-0026](ADR-0026-evidence-backed-done.md) | Evidence-backed Done needs a refusal path | **Accepted** | partial | Delivery twin of ADR-0025. Registry + `check-drivecode-done.ts`; cold-start surfaces cite `claim:<id>`. Stack CI / runbook / ADR-0025 E1 follow. |
