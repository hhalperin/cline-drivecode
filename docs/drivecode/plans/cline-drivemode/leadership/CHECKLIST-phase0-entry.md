...
- [ ] [TASK-GRAPH.md](../delivery/TASK-GRAPH.md) includes sheet / home / graph / recruit / gates in the correct phases.
...
- [x] [schemas/README.md](../../../design/wireframes/README.md) indexes the Phase 0 schema set.
