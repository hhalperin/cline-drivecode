...
Back to [overview.md](overview.md). Depends on: [slice-2](slice-2-enqueue-rank-tick.md) (rank already biases addressed owners). Related: [DRV-AGENT-ROUTER](../../features/DRV-AGENT-ROUTER.md), [10-agent-router.md](../share-and-router/10-agent-router.md).
