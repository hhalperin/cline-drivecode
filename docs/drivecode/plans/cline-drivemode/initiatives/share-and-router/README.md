...
| [../features/DRV-SHOW-BACKLOG.md](../../features/DRV-SHOW-BACKLOG.md) | Show backlog + director tick (**Done** on main #55) |
| [../show-backlog-director/](../show-backlog-director/) | Slice reference (1–7 + S landed); amend, do not rebuild |
