...
- [`docs/drivecode/plans/cline-drivemode/foundation/00-vision.md`](../../foundation/00-vision.md) — north star; "share screen = structured state, not pixels"; Spotlight vs `stage`.
- [`docs/drivecode/plans/cline-drivemode/initiatives/share-screen-canvas/MVP-UI-SHARED-SCREEN.md`](MVP-UI-SHARED-SCREEN.md) — Slice A/B/C plan with the "have / missing" table that names the gaps.
- [`docs/drivecode/plans/cline-drivemode/features/DRV-STAGE.md`](../../features/DRV-STAGE.md) — acceptance criteria for the Spotlight/stage projection.
- [`docs/drivecode/plans/cline-drivemode/features/DRV-SHARE.md`](../../features/DRV-SHARE.md) — structured human share (selection / file / terminal pin); bidirectional share.
- [`docs/drivecode/plans/cline-drivemode/initiatives/share-and-router/PLAN.md`](../share-and-router/PLAN.md) — canonical architecture: dual backlog, DirectorScript, Spotlight priority, mute ⟂ deafen, A2A.
...
- [`docs/drivecode/plans/cline-drivemode/features/DRV-CAPTIONS.md`](../../features/DRV-CAPTIONS.md) — live captions spec (Phase 3 voice).
...
- [`docs/drivecode/README.md`](../../../../design/wireframes/README.md) — authoritative product+code map; `StageState = {sharer, pin, cards}`; hub ops; "Not implemented" list.
- [`docs/drivecode/design/wireframes/DEMO.md`](../../../../design/wireframes/DEMO.md) — runnable demo runbook for the production Join / share-handoff path.
- [`docs/drivecode/reference/architecture.md`](../../../../reference/architecture.md) — architecture diagrams behind the drivecode reference.
- [`docs/drivecode/design/canvases/overview-canvas.html`](../../../../design/canvases/overview-canvas.html) — the self-contained HTML canvas whose style this canvas mirrors.
- [`docs/drivecode/design/brand/CLINE-BRAND-TOKENS.md`](../../../../design/brand/CLINE-BRAND-TOKENS.md) — measured Cline brand tokens (dark bg, purple `#9F58FA`, DM Sans / Schibsted / Space Grotesk).
- [`docs/drivecode/design/wireframes/DRIVE-TAB.md`](../../../../design/wireframes/DRIVE-TAB.md) — Drive tab decision record + throwaway prototype notes.
- [`apps/drivecode-demo/README.md`](../../../../design/wireframes/README.md) — `CLINE_DEMO_*` / `?demoPlans` flag reference; demo adapters at composition roots only.
...
The canvas mirrors [`overview-canvas.html`](../../../../design/canvases/overview-canvas.html)
and the tokens in [`CLINE-BRAND-TOKENS.md`](../../../../design/brand/CLINE-BRAND-TOKENS.md):
