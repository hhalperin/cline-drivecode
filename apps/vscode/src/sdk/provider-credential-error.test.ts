...
describe("describeMissingCredentialError", () => {
	...
	it.each(["Invalid API key", "Unauthorized", "authentication failed", "invalid_api_key", "Model not found", ""])(
		"leaves %j untouched so a wrong key is never relabelled as missing",
		(rawMessage) => {
