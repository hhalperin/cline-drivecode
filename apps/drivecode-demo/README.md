...
| Hub | `?demoPlans=1` | Use demo teams fixture (includes plan **Now · consumer path** from [portfolio-now](../../docs/drivecode/plans/cline-drivemode/initiatives/portfolio-now/)) |
