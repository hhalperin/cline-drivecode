...
- [Plugin examples](../../sdk/examples/plugins) - extend the Cline SDK and CLI with custom tools and event hooks
- [Hook examples](../../sdk/examples/hooks) - lifecycle hooks for logging, blocking, and injection for Cline SDK and CLI
